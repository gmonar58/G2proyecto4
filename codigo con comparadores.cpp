    ...
    do {
        ...
        switch (opcion) {
            case 1: {
                ...
                // Validar cantidad de libros a registrar
                if (cantidad <= 0) {
                    cout << "Debe registrar al menos un libro." << endl;
                    break;
                } else if (cantidad > 5) {
                    cout << "No se pueden registrar más de 5 libros." << endl;
                    break;
                }
            ...
            case 3: {
                ...
                // Verificar si el estudiante tiene un código válido (ejemplo simple)
                if (estudiante.codigo <= 0) {
                    cout << "Código de estudiante inválido." << endl;
                    break;
                }
                ...
                // Validar el número de libro y su disponibilidad
            ...
            case 4: {
                ...
                // Validar número de libro
                if (libroSeleccionado < 1 || libroSeleccionado > 5) {
                    cout << "Número de libro inválido." << endl;
                    break;
                }

                // Verificar si el libro está prestado (disponible == 0)
